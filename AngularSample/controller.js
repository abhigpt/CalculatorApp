...
calculatorModel = {
			...
			calculate: function() {
				...
				switch(this.operation) {
					case "+":
						...
						console.log("in add ",this.result,this.currentNumber);
						break;
						
					case "-":
						this.result = -(this.result) - parseFloat(this.currentNumber);
						console.log("in subtraction ",this.result,this.currentNumber);
						break;
					...
					case "*":
						...
						this.result = this.result * parseFloat(this.currentNumber);
						console.log("in multiplication ",this.result,this.currentNumber);
						break;
					...
					case "/":
						...
						console.log("in division",this.result,this.currentNumber);
        ...
        // Register the calculator-controller to module
